 ...
 *
 * @package    filter/jmol
 * @copyright  2014 onwards Geoffrey Rowland  rowland dot geoff at gmail dot com
...
/**
 * Simple task to delete Jmol filter temp files older than 1 week.
 */
...
class cleanup_task extends \core\task\scheduled_task {
    ...
    public function execute() {
        ...
        $tmpdir = $CFG->dirroot.'/filter/jmol/temp';
