 ...
 * @package    filter
 * @subpackage jmol
 * @copyright  2006 Dan Stowell <david@moodle.com> Original version for Moodle 1.x
 * @copyright  2010 Geoffrey Rowland <growland@strode-college.ac.uk> Update for Moodle 2.x
 * @copyright  2013 Geoffrey Rowland <growland@strode-college.ac.uk> Update for JavaScript/HTML5 JSmol 
